...
<TextWrap>
	...
	<ul>
		<li>
			<a href="https://instagram.com/HominioMe" target="_blank" rel="noopener noreferrer"
				>https://instagram.com/HominioMe</a
			>
		</li>
	</ul>
	...
	<p>
		...
		European data protection standards for data processing in the US. Every company certified under
		the DPF is obliged to comply with these data protection standards. For more information, please
		contact the provider under the following link: <a
